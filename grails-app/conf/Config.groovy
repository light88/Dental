...
// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.dental.domain.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.dental.domain.UserRole'
grails.plugin.springsecurity.authority.className = 'com.dental.domain.Role'
